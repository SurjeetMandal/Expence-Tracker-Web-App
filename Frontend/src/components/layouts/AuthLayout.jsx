import graph_img from "../../assets/Images/graph_img.png"
...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-100 overflow-hidden bg-auth-bg-img bg-cover bg-no-repeat bg-center p-8 relative">
